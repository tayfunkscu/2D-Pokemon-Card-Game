 ...
 * @author Tayfun Kuşçu
 */
public class Jcvc extends javax.swing.JFrame {
    ...
    public static ArrayList<JButton> check_cards_comp1(){
        ArrayList<JButton> computer1 = new ArrayList<JButton>();
        if(jButton4.isVisible()){computer1.add(jButton4);}
        if(jButton5.isVisible()){computer1.add(jButton5);}
        if(jButton6.isVisible()){computer1.add(jButton6);}
        return computer1;
   }
    ...
    public static void computer_vs_computer() {
        ...
        computer1 = check_cards_comp1();
        computer2 = check_cards_comp2();
       
        int com1_secim = select_card(computer1);
        int com2_secim = select_card(computer2);
        
        if(computer1.size() > 0 && computer2.size() > 0){
            ImageIcon icon1 = new ImageIcon(System.getProperty("user.dir")+"\\"+computer1.get(com1_secim).getClientProperty("kartresmi").toString());
            System.out.println(System.getProperty("user.dir")+"\\"+computer1.get(com1_secim).getClientProperty("kartresmi").toString());
            ...
            int com1_damage = Integer.valueOf(computer1.get(com1_secim).getClientProperty("saldırıpuan").toString());
            ...
            computer1.get(com1_secim).setVisible(false);
        ...
        if(other_cards.size() > 0){
            ...
            computer1.get(com1_secim).setIcon(icon1);
            computer1.get(com1_secim).putClientProperty("kartresmi", other_cards.get(ocard1).getClientProperty("kartresmi").toString());
            computer1.get(com1_secim).putClientProperty("isim", other_cards.get(ocard1).getClientProperty("isim").toString());
            computer1.get(com1_secim).putClientProperty("saldırıpuan", other_cards.get(ocard1).getClientProperty("saldırıpuan").toString());
            other_cards.get(ocard1).setVisible(false);
            other_cards.remove(ocard1);
            computer1.get(com1_secim).setVisible(true);
            
            int ocard2  = select_card(other_cards);
            ImageIcon icon2 = new ImageIcon(System.getProperty("user.dir")+"\\"+other_cards.get(ocard2).getClientProperty("kartresmi").toString());
    ...
    private void initComponents() {
        ...
        jButton11.setBounds(720, 250, 100, 40);
        ...
        Computer_Puan2.setBounds(750, 450, 70, 40);
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        String metin = jButton11.getText().toString();
        if(hamle_sayisi <=5){
            System.out.println(hamle_sayisi);
            hamle_sayisi++;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Jcvc(sunum).setVisible(true);
        });
    }
